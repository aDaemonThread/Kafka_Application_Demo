...
public class ElasticSearchConsumerBatchProcessing {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Logger logger = LoggerFactory.getLogger(ElasticSearchConsumerBatchProcessing.class.getName());
        ...
        while(true){
            ...
            logger.info("Fetched:: " + count+" records");
